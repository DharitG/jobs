...
import { AnimatedBeam } from "~/components/magicui/animated-beam" // Adjusted path

// Define Icons component locally or import if available globally
// Using placeholder SVGs from the example for now
const Icons = {
  notion: () => (
  ...
  user: () => (
    <svg
      ...
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor" // Use currentColor for better theme support
      strokeWidth="2"
