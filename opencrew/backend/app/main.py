...
# Include API routers
from .api import users, resumes, jobs, applications, visa # Added visa import
...
# app.include_router(subs.router, prefix="/subscriptions", tags=["subscriptions"]) # Uncomment when subs API is ready
